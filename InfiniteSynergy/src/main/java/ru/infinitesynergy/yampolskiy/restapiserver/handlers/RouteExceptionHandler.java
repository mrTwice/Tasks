...
public class RouteExceptionHandler implements InvocationHandler {
    private static final Logger logger = LogManager.getLogger(RouteExceptionHandler.class);
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        try {
            ...
            return switch (cause) {
                ...
                case UserNameIsNullException userNameIsNullException ->
                        handleThrowable(userNameIsNullException, (HttpRequest) args[0], HttpStatus.CONFLICT);
                case UserIdIsNullException userIdIsNullException ->
                        handleThrowable(userIdIsNullException, (HttpRequest) args[0], HttpStatus.CONFLICT);
                case null, default -> {
                    assert cause != null;
